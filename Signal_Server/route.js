...
router.post(
  "/signal/SignalSumByDateByDevice",
  signalcontroller.getSignalSumByDateByDevice
);
router.post(
  "/signal/SignalSumByDateByDevices",
  signalcontroller.getSignalSumByDateByDevices
);
router.post(
  "/signal/DevicesSumBySignalByDate",
  signalcontroller.getDevicesSumBySignalByDate
);
router.post(
  "/signal/SignalSumFromDeviceByDate",
  signalcontroller.signalSumFromDeviceByDate
);
...
router.get(
  "/accumulations/deviceRUid/:deviceRUid",
  accumulationcontroller.getAccumulationsByDeviceRUid
);
