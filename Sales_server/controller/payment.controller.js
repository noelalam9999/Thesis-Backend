...
const initPayment = (req, res) => {
  ...
  const data = {
    ...
    success_url: "https://order-service.fly.dev/payment-success",
    fail_url: "https://order-service.fly.dev/payment-failure",
    cancel_url: "https://order-service.fly.dev/payment-cancel",
    ipn_url: "https://order-service.fly.dev/payment-ipn",
